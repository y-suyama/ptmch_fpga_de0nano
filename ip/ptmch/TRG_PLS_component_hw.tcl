...
# Sun Jul 21 20:38:32 JST 2024
# DO NOT MODIFY


# 
# TRG_PLS_component "TRG_PLS_component" v1.0
#  2024.07.21.20:38:32
# 
# 
...
add_fileset_file ptmch_top.sv SYSTEM_VERILOG PATH ip/ptmch/ptmch_top.sv TOP_LEVEL_FILE
add_fileset_file ptmch_cnt.sv SYSTEM_VERILOG PATH ip/ptmch/ptmch_cnt.sv
add_fileset_file ptmch_reg.sv SYSTEM_VERILOG PATH ip/ptmch/ptmch_reg.sv
add_fileset_file ptmch_trg.sv SYSTEM_VERILOG PATH ip/ptmch/ptmch_trg.sv
...
set_interface_property reg associatedReset RESET_N
...
set_interface_property CLK160M clockRate 0
...
set_interface_property TRG_PLS associatedReset RESET_N
...
add_interface_port TRG_PLS TRG_PLS monitorsignal Output 5
...
set_interface_property SPI_CS associatedReset RESET_N
...
add_interface_port SPI_CS SPI_CS spi_cs Input 1
...
set_interface_property SPI_MOSI associatedReset RESET_N
...
add_interface_port SPI_MOSI SPI_MOSI spi_mosi Input 1
