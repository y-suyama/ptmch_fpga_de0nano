...
module de0_nano_system_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [102:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> key_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // sw_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [102:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_s1_agent:cp_data
	...
	wire   [84:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [102:0] key_s1_agent_rp_data;                                                      // key_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [102:0] sw_s1_agent_rp_data;                                                       // sw_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [102:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_004:sink0_data
	wire          cmd_demux_001_src2_ready;                                                  // cmd_mux_004:sink0_ready -> cmd_demux_001:src2_ready
	wire    [6:0] cmd_demux_001_src2_channel;                                                // cmd_demux_001:src2_channel -> cmd_mux_004:sink0_channel
	...
	wire    [6:0] cmd_demux_001_src3_channel;                                                // cmd_demux_001:src3_channel -> cmd_mux_005:sink0_channel
	...
	wire    [6:0] cmd_demux_001_src4_channel;                                                // cmd_demux_001:src4_channel -> cmd_mux_006:sink0_channel
	...
	wire  [102:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> rsp_mux_001:sink2_data
	wire          rsp_demux_004_src0_ready;                                                  // rsp_mux_001:sink2_ready -> rsp_demux_004:src0_ready
	wire    [6:0] rsp_demux_004_src0_channel;                                                // rsp_demux_004:src0_channel -> rsp_mux_001:sink2_channel
	...
	wire    [6:0] rsp_demux_005_src0_channel;                                                // rsp_demux_005:src0_channel -> rsp_mux_001:sink3_channel
	...
	wire    [6:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> rsp_mux_001:sink4_channel
	...
	wire   [84:0] router_005_src_data;                                                       // router_005:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                      // sdram_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [6:0] router_005_src_channel;                                                    // router_005:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [102:0] sdram_s1_rsp_width_adapter_src_data;                                       // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                      // rsp_demux_003:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire    [6:0] sdram_s1_rsp_width_adapter_src_channel;                                    // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire  [102:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                     // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	de0_nano_system_mm_interconnect_0_router_005 router_005 (
	...
	de0_nano_system_mm_interconnect_0_router_006 router_007 (
	...
	de0_nano_system_mm_interconnect_0_router_006 router_008 (
	...
	de0_nano_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de0_nano_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de0_nano_system_mm_interconnect_0_avalon_st_adapter_003 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
